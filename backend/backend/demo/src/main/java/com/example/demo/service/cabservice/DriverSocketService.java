...
public class DriverSocketService {
    ...
    public void goOnline(String token  , double lat, double lng) {
                ...
                redisService.goOnline(driver.getDriverId(), lat, lng);
        }
        ...
        public void goOffline(String token) {
                ...
                redisService.goOffline(driver.getDriverId());
        }
        ...
        public void gpsUpdate(String token, double lat, double lng) {
                ...
                redisService.updateLocation(driver.getDriverId(), lat, lng);
                Ride ride = rideRepo.findByDriverIdAndStatus(driver.getDriverId(), RideStatus.DRIVER_ASSIGNED)
                                // .orElseThrow(() -> new RuntimeException("Driver not found")); // Don't throw
                                // if no ride
                                .orElse(new Ride());
